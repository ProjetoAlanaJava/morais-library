...
public class Constantes {
    //"x-requestd-with" " "origin", "accept",
    public static final List<String> METODOS_PERMITIDOS = Arrays.asList("GET", "POST", "PUT", "DELETE");

    public static final List<String> HEADERS_PERMITIDOS = Arrays.asList("content-type", "authorization", "access_token", "username", "password");
